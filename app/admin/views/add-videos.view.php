...
<html lang="en">
  <head>
    ...
    <title><?php echo $_SITE_NAME ?> | Admin Tambah Video</title>
                    ...
                    <div class="card-body">
                        <form action="add-videos.php" method="POST" enctype="multipart/form-data"> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="file" accept="image/*" class="form-control" id="thumbnail" name="thumbnail" placeholder="Thumbnail" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="url" class="col-sm-2 col-form-label">Youtube Url</label>
                                <div class="col-sm-10">
                                <input type="url" class="form-control" id="url" name="url" placeholder="Contoh: https://www.youtube.com/watch?v=5gKrkxr0pU8" required>
                                </div>
                            </div>
                            <div class="form-group row">
