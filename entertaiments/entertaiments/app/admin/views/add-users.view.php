...
<html lang="en">
  <head>
    ...
    <title><?php echo $_SITE_NAME ?> | Admin Tambah Pengguna</title>
                    ...
                    <div class="card-body">
                        <form action="add-users.php" method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" name="first_name" class="form-control" id="firstName" placeholder="Nama Depan" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="lastName" class="col-sm-2 col-form-label">Nama Belakang</label>
                                <div class="col-sm-10">
                                <input type="text" name="last_name" class="form-control" id="lastName" placeholder="Nama Belakang">
                                </div>
                            </div>
                            <div class="form-group row">
